/**
 * PeopleOS — SalaryRuleTable Component
 * Module: Salary Rules
 * Owner: Member 3
 *
...
const SalaryRuleTable = ({ data = [], loading = false, error = null, onEdit, onDelete }) => {
  if (loading) return <Loading message="Loading salary rules..." />;
  if (error)   return <ErrorMessage message={error} />;
  if (!data.length) return <EmptyState title="No Salary Rules Found" description="No records to display." />;
