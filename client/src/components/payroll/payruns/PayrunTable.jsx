/**
 * PeopleOS — PayrunTable Component
 * Module: Payruns
 * Owner: Member 3
 *
...
const PayrunTable = ({ data = [], loading = false, error = null, onEdit, onDelete }) => {
  if (loading) return <Loading message="Loading payruns..." />;
  if (error)   return <ErrorMessage message={error} />;
  if (!data.length) return <EmptyState title="No Payruns Found" description="No records to display." />;
