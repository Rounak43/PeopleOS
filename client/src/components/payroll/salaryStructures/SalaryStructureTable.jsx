/**
 * PeopleOS — SalaryStructureTable Component
...
const SalaryStructureTable = ({ data = [], loading = false, error = null, onEdit, onDelete }) => {
  if (loading) return <Loading message="Loading salary structures..." />;
  if (error)   return <ErrorMessage message={error} />;
  if (!data.length) return <EmptyState title="No Salary Structures Found" description="No records to display." />;
