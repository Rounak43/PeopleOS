/**
 * PeopleOS — AttendanceTable Component
 * Module: Attendance
 * Owner: Member 2
 *
...
const AttendanceTable = ({ data = [], loading = false, error = null, onEdit, onDelete }) => {
  if (loading) return <Loading message="Loading attendance..." />;
  if (error)   return <ErrorMessage message={error} />;
  if (!data.length) return <EmptyState title="No Attendance Found" description="No records to display." />;
