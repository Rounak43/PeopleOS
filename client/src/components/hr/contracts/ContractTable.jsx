/**
 * PeopleOS — ContractTable Component
 * Module: Contracts
 * Owner: Member 2
 *
...
const ContractTable = ({ data = [], loading = false, error = null, onEdit, onDelete }) => {
  if (loading) return <Loading message="Loading contracts..." />;
  if (error)   return <ErrorMessage message={error} />;
  if (!data.length) return <EmptyState title="No Contracts Found" description="No records to display." />;
