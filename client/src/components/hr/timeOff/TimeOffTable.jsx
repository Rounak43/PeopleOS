/**
 * PeopleOS — TimeOffTable Component
 * Module: Time Off
 * Owner: Member 2
 *
...
const TimeOffTable = ({ data = [], loading = false, error = null, onEdit, onDelete }) => {
  if (loading) return <Loading message="Loading time off..." />;
  if (error)   return <ErrorMessage message={error} />;
  if (!data.length) return <EmptyState title="No Time Off Found" description="No records to display." />;
