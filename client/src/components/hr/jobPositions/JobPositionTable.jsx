/**
 * PeopleOS — JobPositionTable Component
...
const JobPositionTable = ({ data = [], loading = false, error = null, onEdit, onDelete }) => {
  if (loading) return <Loading message="Loading job positions..." />;
  if (error)   return <ErrorMessage message={error} />;
  if (!data.length) return <EmptyState title="No Job Positions Found" description="No records to display." />;
