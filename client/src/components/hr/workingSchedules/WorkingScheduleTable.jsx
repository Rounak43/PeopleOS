/**
 * PeopleOS — WorkingScheduleTable Component
...
const WorkingScheduleTable = ({ data = [], loading = false, error = null, onEdit, onDelete }) => {
  if (loading) return <Loading message="Loading working schedules..." />;
  if (error)   return <ErrorMessage message={error} />;
  if (!data.length) return <EmptyState title="No Working Schedules Found" description="No records to display." />;
