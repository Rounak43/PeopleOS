/**
 * PeopleOS — EmployeeTable Component
 * Module: Employees
 * Owner: Member 2
 *
...
const EmployeeTable = ({ data = [], loading = false, error = null, onEdit, onDelete }) => {
  if (loading) return <Loading message="Loading employees..." />;
  if (error)   return <ErrorMessage message={error} />;
  if (!data.length) return <EmptyState title="No Employees Found" description="No records to display." />;
